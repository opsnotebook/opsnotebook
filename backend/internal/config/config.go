...
// Pattern format matches group_by keys (e.g., "staging:sg:*" for ["environment", "region", "name"])
...
// filterTargets filters targets by glob pattern matching against the joined group key
